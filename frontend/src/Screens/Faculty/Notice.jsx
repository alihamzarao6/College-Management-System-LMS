...
const Notice = () => {
    ...
    const getNoticeHandler = () => {
        ...
        axios
            .post(`${baseApiURL}/notice/getNotice`, { ...data, teacherId: userInfo.userId, }, {
                headers: headers,
            })
            .then((response) => {
                if (response.data.success) {
                    setNotice((prevNotice) => [...prevNotice, ...response.data.notice]);
                } else {
    ...
    const addNoticehandler = (e) => {
        ...
        axios
            .post(`${baseApiURL}/notice/addNotice`, { ...data, teacherId: userInfo.userId, }, {
                headers: headers,
            })
            .then((response) => {
                toast.dismiss();
    ...
    const updateNoticehandler = (e) => {
        ...
        axios
            .post(`${baseApiURL}/notice/updateNotice/${id}`, { ...data, teacherId: userInfo.userId, }, {
                headers: headers,
            })
            .then((response) => {
                toast.dismiss();
    ...
    const setOpenEditSectionHandler = (index) => {
        ...
        setData({
            ...
            teacherId: notice[index].teacherId,
        });
            ...
            {!open && (
                <div className="mt-8 w-full">
                    {notice ?
                                    ...
                                    {(router.pathname === "/faculty" ||
                                        router.pathname === "/admin") && (
                                            <div className="absolute flex justify-center items-center right-4 bottom-3">
                                                ...
                                                {item.teacherId === userInfo.userId && (
                                                    <>
                                                        <span
                        ...
                        : <p className="mt-10">No Notice is available to show!</p> 
                       }
                </div>
            )}
            {open && (
                <form className="mt-8 w-full">
                    <div className="w-full sm:w-[70%] md:w-[60%] lg:w-[40%] mt-2">
                    ...
                    <div className="w-full sm:w-[70%] md:w-[60%] lg:w-[40%] mt-4">
