...
router.post("/getDetailsDep", async (req, res) => {
  try {
    let user = await facultyDetails
      .find(req.body)
...
router.get("/getDetails/:id", async (req, res) => {
  try {
    const user = await facultyDetails.findById(req.params.id);
...
router.post("/addDetails", async (req, res) => {
  try {
    ...
    let user = await facultyDetails.findOne({ employeeId });
